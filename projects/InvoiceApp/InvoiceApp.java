 ...
 *
 * @author Tristan Joubert, Tom Kraan
 * @version 2.0
 * @link https://github.com/TJoubert004/Assignment1InvoiceApp
 */
...
public class InvoiceApp {
    ...
    /**
     * Decide discount percentage based on subtotal
     * @param subTotal Price of item times its quantity
     */
    ...
    private static void printReceipt(List<String> descriptionList, List<Integer> qtyList, List<Double> priceList) {
        ...
        for (int i = 0; i < descriptionList.size(); i++) {
            ...
            subTotal = qty * price;
            discountPercentage = getDiscountPercent(subTotal);
            ...
            System.out.printf("%20s %3d%%    -$%,6.2f = $%,8.2f\n", "Discount", (int)(discountPercentage*100), discountAmount, (subTotal - discountAmount));    
            }
